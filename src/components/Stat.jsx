	...
	return (
		<div className="stats flex flex-wrap items-center justify-center py-32 bg-base-300 text-base-content">
			<div className="stat max-w-64">
				<div className="stat-figure tooltip tooltip-primary text-primary" data-tip="Total bugatties sold in the last month">
					<svg
			...
			<div className="stat max-w-64">
				<div className="stat-figure tooltip tooltip-primary text-primary" data-tip="New Customers visit in the last month">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
			...
			<div className="stat max-w-64">
				<div className="stat-figure tooltip tooltip-primary text-primary" data-tip="New Customers registered in the last month">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
						viewBox="0 0 24 24"
