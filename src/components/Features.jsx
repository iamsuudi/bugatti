			...
			<div className="card w-[90%] max-w-[35rem] bg-base-100 shadow-xl">
				<div className="card-body gap-7">
					...
					<p className="max-w-lg">
						Join us as we invite you to experience the epitome of
						automotive luxury and innovation. Discover the legacy,
						ignite your passion, and become part of the Bugatti
						family today
					</p>
